...
public class APITextFileReader implements APITestDataReader {
    private static final Logger log = Logger.getLogger("APITextFileReader");
    private final APIPropertyQueryConfig propertyQueryConfig;

    @Inject
    public APITextFileReader(APIPropertyQueryConfig propertyQueryConfig) {
            ...
            try {
                ...
                for (int i = 0; url != null && i < numOfRecs; i++) {
                    ...
                    if (StringUtils.isNotBlank(url)) {
                        String scenario = String.valueOf(i + 1);
    ...
    public BufferedReader getFileContents(String requestFileSource) {
        ...
        String requestFileName = propertyQueryConfig.getFileName(requestFileSource);
