...
public class APITestRequest implements Serializable {
	private static final long serialVersionUID = 2847528211400048875L;
	...
	private APITestInputSource urlParamInputSource = null;
	private APITestInputSource payloadInputSource = null;
	private APITestInputSource validationInputSource = null;
	private APITestInputSource headerParamInputSource = null;

	private List<APIValidationField> validationFields;
	private List<APIPrintField> printFields;
	...
	private Integer invocationCount = 1;

	private List<APIPrintField> contextFields = null;
	private Map<String, Map<String, Object>> contextValues = null;

	private APITestRequest() {
		validationFields = new ArrayList<APIValidationField>();
		printFields = new ArrayList<APIPrintField>();
		contextFields = new ArrayList<APIPrintField>();
	}

	public static APITestRequest getInstance() {
	...
	public void setApiToTest(API apiToTest) {
	...
	public List<APIValidationField> getValidationFields() {
		return validationFields;
	}

	public void setValidationFields(List<APIValidationField> validationFields) {
		this.validationFields = validationFields;
	}

	public void addValidationField(String name, APIValidationField field) {
	...
	public List<APIPrintField> getPrintFields() {
		return printFields;
	}

	public void setPrintFields(List<APIPrintField> printFields) {
		this.printFields = printFields;
	}

	public void addPrintField(APIPrintField printField) {
	...
	public Integer getThreadPoolSize() {
		if (threadPoolSize != null && threadPoolSize > 0)
			...
			return APITestConstants.DEFAULT_THREAD_POOL_SIZE;
	}
	...
	public APITestInputSource getUrlParamInputSource() {
		return urlParamInputSource;
	}

	public void setUrlParamInputSource(APITestInputSource urlParamInputSource) {
		this.urlParamInputSource = urlParamInputSource;
	}

	public APITestInputSource getPayloadInputSource() {
		return payloadInputSource;
	}

	public void setPayloadInputSource(APITestInputSource payloadInputSource) {
	...
	public APITestInputSource getValidationInputSource() {
		return validationInputSource;
	}

	public void setValidationInputSource(APITestInputSource validationInputSource) {
	...
	public APITestInputSource getHeaderParamInputSource() {
		return headerParamInputSource;
	}

	public void setHeaderParamInputSource(APITestInputSource headerParamInputSource) {
		this.headerParamInputSource = headerParamInputSource;
	}

	public List<APIPrintField> getContextFields() {
		return contextFields;
	}

	public void setContextFields(List<APIPrintField> context) {
		this.contextFields = context;
	}

	public void addContextField(APIPrintField field) {
