...
public class APICompareTestsResponseItem implements Serializable {
	...
	private APIScenarioResponse response1;
	private APIScenarioResponse response2;
	...
	public APIScenarioResponse getResponse1() {
		return response1;
	}

	public void setResponse1(APIScenarioResponse response1) {
		this.response1 = response1;
	}

	public APIScenarioResponse getResponse2() {
		return response2;
	}

	public void setResponse2(APIScenarioResponse response2) {
