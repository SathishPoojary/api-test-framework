...
import com.shc.automation.api.test.framework.internal.response.validators.APIMessageFactory;
...
public class APIValidation implements Serializable {
	...
	@Inject
	private APIMessageFactory messageFactory;

	public APIValidation(String fieldName, String fieldPath, String desiredValue, ValidationType validationType) {
	...
	public APIValidation(String fieldName, String fieldPath, ValidationType validationType) {
	...
	@JsonIgnore
	public APIValidation getCopy() {
		APIValidation validation = new APIValidation(validationName, getResponsePath(), validationType);
	...
	public void updateValidationMessage() {
		...
		if (StringUtils.isNotBlank(messageId)) {
			messageFromResource = messageFactory.getMessage(messageId.trim(), validationResult);
		}
