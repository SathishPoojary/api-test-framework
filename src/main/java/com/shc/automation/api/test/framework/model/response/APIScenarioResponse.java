 ...
 *
 */
public class APIScenarioResponse implements Serializable {
    ...
    private List<APIValidation> validators;
    private List<APIPrint> printers;
    ...
    public APIScenarioResponse() {
        ...
        printers = new ArrayList<APIPrint>();
    }
    ...
    public void setValidator(APIValidation validator) {
    ...
    public List<APIPrint> getPrinters() {
        return printers;
    }

    public void setPrinters(List<APIPrint> printFields) {
        this.printers = printFields;
    }

    public void addPrinter(APIPrint printField) {
    ...
    public void updateFromScenarioRequest(APIScenarioRequest scenarioRequest) {
        this.setBaseUrl(scenarioRequest.getUrl());
        this.setPayLoad(scenarioRequest.getPayload());
        this.setScenarioName(scenarioRequest.getScenarioName());
        this.setUrlParameters(scenarioRequest.getUrlParameters());
        this.setValidStatusCodes(scenarioRequest.getValidStatusCodes());
        this.setRequestType(scenarioRequest.getRequestType());
        this.setContext(scenarioRequest.getScenarioContext());
        this.setRequestHeaders(scenarioRequest.getHeaders());
        if (this.getValidResponse()) {
            this.setValidators(scenarioRequest.getValidators());
        }
    }
    ...
    public void saveSession(CloseableHttpClient http, HttpClientContext context) {
        setHttpClient(http);
    ...
    public HttpClientContext getHttpClientContext(APIScenarioResponse response) {
        HttpClientContext context = null;
        if (CollectionUtils.isNotEmpty(response.getCookies())) {
