...
public class APIChainStepResponseProcess extends APIAfterResponseProcess {
	protected APIScenarioResponse stepResponseItem;
	 ...
	 */
	public APIChainStepResponseProcess(APIScenarioResponse stepResponseItem) {
	 ...
	 */
	public void process(APIScenarioRequest nextStepRequestItem) {
		...
		//nextStepRequestItem.setUrlParameters(new APIUrlReader().read(urlParameters);
